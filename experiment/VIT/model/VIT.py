...
class vit(nn.Module):
    def __init__(self):
        super().__init__()
        self.layer1 = ViTForImageClassification.from_pretrained(
            "google/vit-base-patch16-224"
        ).vit.encoder
        self.layer2 = ViTForImageClassification.from_pretrained(
            "google/vit-base-patch16-224"
        ).vit.layernorm
        self.layer3 = ViTForImageClassification.from_pretrained(
            "google/vit-base-patch16-224"
        ).classifier
...
file_path = "/mlir-cgra/experiments/VIT/model/000000039769.jpg"
